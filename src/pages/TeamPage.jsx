...
const teamMembers = [
  ...
  },
  {
    ...
    name: 'Username',
    position: 'Position',
    image: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80',
    bgColor: 'bg-gray-200'
  },
  {
    id: 9,
    ...
    <div className="bg-white">
      ...
      <div className="lg:hidden flex flex-col w-full">
        ...
        <div className="px-4 pt-6 pb-3">
          <div className="text-center mb-2 text-gray-500 text-xs uppercase tracking-wider">
            What we do
          </div>
          ...
          <div className="flex justify-center items-center space-x-2 mb-4">
            <Link to="/" className="text-sm text-gray-800">Home</Link>
            <span className="text-gray-400">•</span>
            <Link to="/team" className="text-sm text-gray-800">Team</Link>
          </div>
        </div>
        
        {/* Fashion Images - With gap */}
          ...
          <div className="grid grid-cols-2 gap-1 w-full">
            ...
            <div className="relative bg-gray-200">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                <p className="text-xs uppercase tracking-wide">Womens</p>
                <p className="text-xl font-bold">COAT</p>
              </div>
            </div>
            ...
            <div className="bg-gray-200">
              <img 
                src="https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=688&q=80" 
                alt="Woman in black" 
          ...
          <div className="space-y-6">
            {teamMembers.map((member) => (
              <div key={member.id} className="flex flex-col items-center">
                ...
                <h3 className="font-medium text-gray-800 text-center mb-1">{member.name}</h3>
                <p className="text-sm text-gray-500 text-center mb-2">{member.position}</p>
        ...
        {/* CTA Section */}
        <div className="mt-auto px-4 py-8 bg-blue-500 text-center text-white">
          ...
          <button className="bg-white text-blue-500 px-8 py-3 rounded-md font-medium mb-8">
            Try it free now
          </button>
      ...
      <div className="hidden lg:block w-full">
        {/* Header Section */}
        <div className="">
          <div className="text-center mb-2 text-gray-500 text-xs uppercase tracking-wider py-8">
            What we do
          </div>
          ...
          <div className="flex justify-center space-x-6 mb-8">
            ...
            <span className="text-gray-400">•</span>
            <Link to="/team" className="text-gray-800 hover:text-blue-500">Team</Link>
          </div>
          
          {/* Images Grid - With gaps but full width */}
          <div className="grid grid-cols-2 gap-1 w-full">
            {/* Left side - Big yellow outfit */}
            <div className="h-[533.48px]">
              <img 
                src="https://images.unsplash.com/photo-1509631179647-0177331693ae?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1288&q=80" 
                alt="Person in stylish outfit" 
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-1">
              ...
              <div className="relative bg-red-600">
                <img 
                  src="https://images.unsplash.com/photo-1576871337622-98d48d1cf531?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" 
                  alt="Woman in red coat" 
                  className="w-full h-[265px] object-cover brightness-90"
                />
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                  <p className="text-xs uppercase tracking-wide">Womens</p>
                  <p className="text-2xl font-bold">COAT</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-8">
              ...
              <div key={member.id} className="flex flex-col items-center">
                ...
                <img
                  ...
                  <h3 className="font-medium text-gray-800 text-center mb-1">{member.name}</h3>
                  <p className="text-sm text-gray-500 text-center mb-3">{member.position}</p>
                  <div className="flex justify-center space-x-3">
                    <a href="#" className="text-blue-500">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
        ...
        <div className="bg-blue-500 py-12">
          <div className="container mx-auto px-4 text-center text-white">
            ...
            <p className="mb-8 max-w-md mx-auto text-blue-100">
              Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.
              <br />No cash, credit card required.
            </p>
            <button className="bg-white text-blue-500 px-8 py-3 rounded-md font-medium mb-10">
              Try it free now
            </button>
            <div className="flex justify-center space-x-4">
              <a href="#" className="text-white hover:text-blue-200">
