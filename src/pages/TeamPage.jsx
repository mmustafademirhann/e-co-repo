  ...
  return (
    <div className="bg-white">
      ...
      <div className="lg:hidden flex flex-col w-full">
        ...
        {/* CTA Section - Mobile */}
        <div className="mt-8 px-4 py-12 bg-gray-50 text-center">
          <h2 className="text-2xl font-bold mb-3 text-gray-800">
            Start your 14 days free trial
          </h2>
          <p className="text-gray-500 mb-8">
            Met minim Mollie non desert Alamo est sit<br />cliquey dolor do met sent. RELit official consequent.
          </p>
          <button className="bg-blue-500 text-white px-12 py-3 rounded-md font-medium mb-10">
            Try it free now
          </button>
